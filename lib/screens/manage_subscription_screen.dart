...
// TODO: Update this import to the actual path of your shared PrimaryButton widget.
...
class _ManageSubscriptionScreenState extends State<ManageSubscriptionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: SafeArea(
        ...
        child: PrimaryButton(
          label: _selectedProductId == 'plan_pro' ? 'Upgrade to Pro' : 'Continue',
          onTap: _selectedProductId != null ? _handleUpgrade : null,
        ),
      ),
    );
  }
  ...
  Widget _buildSubscriptionTiers(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Subscription Tiers', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700)),
        const SizedBox(height: 12),
        Column(
          children: _plans
              .map(
  ...
  Widget _buildCreditPacks(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Credit Packs', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700)),
        const SizedBox(height: 8),
        Text('One-time purchase for extra styles.', style: Theme.of(context).textTheme.bodyMedium),
        const SizedBox(height: 12),
        SizedBox(
          height: 140,
